...
const countries = [
  ...
  { name: "Thailand", iso_code: "TH", region: "Asia" },
];
const providers = [
  {
    name: "Airalo",
...
const planSeeds = [
  ...
  {
    id: "ffffffff-ffff-ffff-ffff-ffffffff0015",
    provider_name: "Holafly",
    country_iso: "JP",
    data_gb: 999,
    validity_days: 15,
  ...
  {
    id: "ffffffff-ffff-ffff-ffff-ffffffff0030",
    provider_name: "Holafly",
    country_iso: "JP",
    data_gb: 999,
    validity_days: 30,
  ...
  {
    id: "99999999-9999-9999-9999-999999990015",
    provider_name: "Holafly",
    country_iso: "TH",
    data_gb: 999,
    validity_days: 15,
  ...
  {
    id: "99999999-9999-9999-9999-999999990030",
    provider_name: "Holafly",
    country_iso: "TH",
    data_gb: 999,
    validity_days: 30,
